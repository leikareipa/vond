...
// A collection of image_s<> instances, representing tiles of a larger image (the
...
class image_mosaic_c
{
public:
    image_mosaic_c(const unsigned numTilesX, const unsigned numTilesY, const unsigned tileWidth, const unsigned tileHeight) :
        numTilesX(numTilesX),
        numTilesY(numTilesY),
        tileWidth(tileWidth),
        tileHeight(tileHeight),
        tiles(new const image_s<T, NumImageColorChannels>*[numTilesX * numTilesY])
    {
    ...
    void insert_at(const unsigned tilePosX, const unsigned tilePosY, const image_s<T, NumImageColorChannels> *const image)
    {
...
private:
    ...
    const image_s<T, NumImageColorChannels> **tiles;
};
